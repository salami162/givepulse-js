...
}).call(this, function(root, Backbone, _, $) {
...
// define env
define('env',['backbone'], function (Backbone) {
...
;
/* START_TEMPLATE */
define('hbs!template/opportunity',['hbs','Handlebars'], function( hbs, Handlebars ){ 
...
function program1(depth0,data) {
  ...
  buffer += "<table>\n";
  foundHelper = helpers.opportunities;
  stack1 = foundHelper || depth0.opportunities;
  stack2 = helpers.each;
  ...
  buffer += "\n</table>";
  return buffer;});
Handlebars.registerPartial('template_opportunity', t);
return t;
});
/* END_TEMPLATE */
;
define('view/opportunity',[
	'backbone',
...
define('collection/opportunities',[
	'backbone', 
	'model/opportunity'
